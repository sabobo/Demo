...
public class Garden {
    ...
    public Bloom createRandomBloom(int x, int y){
        return createBloom(x, y, randomInt(options.bloomRadius_min, options.bloomRadius_max),
                Garden.randomrgba(options.color_rmin, options.color_rmax,
                        options.color_gmin, options.color_gmax,
                        options.color_bmin, options.color_bmax,
                        options.opacity),
                Garden.randomInt(options.petalCount_min, options.petalCount_max));
    }
